...
const TICKER = [
  { login: "torvalds", rating: 96, tier: "Legend" },
  { login: "gaearon", rating: 87, tier: "Gold" },
  { login: "sindresorhus", rating: 91, tier: "Legend" },
  { login: "yyx990803", rating: 89, tier: "Gold" },
  { login: "tj", rating: 84, tier: "Gold" },
  { login: "addyosmani", rating: 79, tier: "Silver" },
  { login: "kentcdodds", rating: 82, tier: "Gold" },
  { login: "wesbos", rating: 76, tier: "Silver" },
];
    ...
    <main className="mow-lines relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 mx-auto flex max-w-3xl flex-col items-center px-6 pb-12 pt-6 text-center sm:pt-12">
        <motion.p
          ...
          className="font-display text-xs uppercase tracking-[0.3em] text-bail"
        >
          Rate your GitHub out of 99
        </motion.p>
        ...
        >
          Your GitHub, rated
          <br className="hidden sm:block" /> as a cricket card
        </motion.h1>
        ...
        >
          Commits become strike rate. Pull requests become wickets. Stars become boundaries.
          Enter a GitHub username and get your card in seconds.
        </motion.p>
        ...
        >
          <div
            ...
            style={{
              borderColor: focused ? "#C79A3E" : "#2F6B3C",
              boxShadow: focused ? "0 0 0 4px rgba(199,154,62,0.2)" : "none",
            }}
          >
            <span className="pl-4 font-mono text-sm text-ink/40">github.com/</span>
            <input
              type="text"
              value={username}
          ...
          <button
            type="submit"
            className="w-full rounded-md bg-bail py-3 font-display text-sm font-semibold uppercase tracking-widest text-ink transition hover:scale-[1.01] hover:opacity-90 active:scale-[0.99]"
          >
            Get my card
          </button>
        ...
        >
          ...
          <code className="text-chalk/60">![card](gitwicket.dev/api/card/yourname)</code>
        </motion.p>
      </section>
      ...
      {/* three-point pitch */}
      <section className="relative z-10 mx-auto grid max-w-5xl grid-cols-1 gap-6 px-6 py-16 sm:grid-cols-3">
        {[
          {
            title: "Real numbers, real card",
            copy: "Six live GitHub signals — commits, PRs, reviews, stars, followers, active years — mapped straight onto a FUT-style stat grid.",
          },
          {
